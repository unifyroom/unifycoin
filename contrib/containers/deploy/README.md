...
official/supported Docker Images found at https://hub.docker.com/r/unifyroom/unifycoin/
...
**NOTE: Please update the image description at https://hub.docker.com/r/unifyroom/unifycoin-develop/ when changing the above text**