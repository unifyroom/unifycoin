# Bootstrappable Unifyroom Core Builds

This directory contains the files necessary to perform bootstrappable Unifyroom
Core builds.
...
To build Unifyroom Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Unifyroom Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/unfy-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/unifyroom/guix.sigs).
...
[guix-docker]: https://github.com/unifyroom/unifycoin/tree/master/contrib/guix/Dockerfile
