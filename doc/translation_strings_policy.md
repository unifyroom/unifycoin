...
This document provides guidelines for internationalization of the Unifyroom Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `unfy_en.ts` remains unchanged.
