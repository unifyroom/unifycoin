# Support for Output Descriptors in Unifyroom Core

Since Unifyroom Core v0.17, there is support for Output Descriptors. This is a
...
existing Unifyroom Core wallets, a convenience function `combo` is
...
All RPCs in Unifyroom Core will include the checksum in their output. Only
