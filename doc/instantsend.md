...
This mechanism has been integrated into Bitcore-Node-Unifyroom which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/unifyroom/insight-api-unfy#web-socket-api](https://github.com/unifyroom/insight-api-unfy#web-socket-api)
* API: [https://github.com/unifyroom/insight-api-unfy#instantsend-transactions](https://github.com/unifyroom/insight-api-unfy#instantsend-transactions)
