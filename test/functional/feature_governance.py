#!/usr/bin/env python3
# Copyright (c) 2018-2020 The Unifyroom Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Tests around unfy governance."""
...
class UnifyroomGovernanceTest (UnifyroomTestFramework):
    def set_test_params(self):
        ...
        self.set_unfy_test_params(6, 5, [["-budgetparams=10:10:10", f"-vbparams=v20:{self.v20_start_time}:999999999999:10:8:6:5:0"]] * 6, fast_dip3_enforcement=True)
