...
"""Verify that starting unfyd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start unfyd with -h for help text")
        ...
        self.log.info("Start unfyd with -version for version information")
        ...
        self.log.info("Start unfydd with -fakearg to make sure it does not start")
