...
class LLMQCoinbaseCommitmentsTest(UnifyroomTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as UnifyroomTestFramework doesn't support this atm)
