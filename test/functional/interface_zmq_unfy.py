...
"""Test the unfy specific ZMQ notification interfaces."""
...
class UnifyroomZMQTest (UnifyroomTestFramework):
    def set_test_params(self):
        ...
        self.set_unfy_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that unfyd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all unfy related ZMQ publisher
