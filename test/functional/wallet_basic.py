...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 UNFY from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 UNFY in block rewards plus fees, but
        ...
        # Send 100 UNFY with subtract fee from amount
        ...
        # Sendmany 100 UNFY with subtract fee from amount
        ...
        # Sendmany with explicit fee (UNFY/kB)
        ...
        # This will raise an exception for attempting to get the private key of an invalid Unifyroom address
        assert_raises_rpc_error(-5, "Invalid Unifyroom address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Unifyroom address
        assert_raises_rpc_error(-5, "Invalid Unifyroom address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Unifyroom address or script", self.nodes[0].importaddress, "invalid")
        ...
        # send with explicit unfy/kb fee
        self.log.info("test explicit fee (sendtoaddress as unfy/kb)")
        self.nodes[0].generate(1)
        self.sync_all(self.nodes[0:3])
