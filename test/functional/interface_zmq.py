...
from test_framework.messages import unfyhash, hash256
...
def unfyhash_reversed(byte_str):
    return unfyhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], unfyhash_reversed(block[:80]).hex())
