...
static const std::string DEFAULT_FOUNDER_ADDRESS = "UQNrkGsfJ8UN3pRTyEuVrKEisCP2wbrTk1";
...
public:
	...
	bool FillFounderPayment(CMutableTransaction& txNew, int nBlockHeight, CAmount blockReward, CTxOut& txoutFounderRet);
