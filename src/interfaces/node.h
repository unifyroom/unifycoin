...
//! Interface for the src/evo part of a unfy node (unfyd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a unfy node (unfyd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a unfy node (unfyd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a unfy node (unfyd process).
...
//! Top-level interface for a unfy node (unfyd process).
class Node
{
public:
    virtual ~Node() {}
