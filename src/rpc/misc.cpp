...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"unfy\" activates all Unifyroom-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "unfy")
    + HelpExampleRpc("debug", "unfy+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The unfy address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The unfy address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "unfy-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Unifyroom features */
    { "unfy",               "mnsync",                 &mnsync,                 {} },
    { "unfy",               "spork",                  &spork,                  {"command"} },
    { "unfy",               "sporkupdate",            &sporkupdate,            {"name","value"} },
