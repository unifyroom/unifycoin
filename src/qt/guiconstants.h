...
/* UnifyroomGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* UnifyroomGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Unifyroom"
#define QAPP_ORG_DOMAIN "unifyroom.com"
#define QAPP_APP_NAME_DEFAULT "Unifyroom-Qt"
#define QAPP_APP_NAME_TESTNET "Unifyroom-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Unifyroom-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Unifyroom-Qt-regtest"
