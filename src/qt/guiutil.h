...
/** Utility functions used by the Unifyroom Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "unfy:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load unfy specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a unfy specific theme is activated (light/dark).*/
