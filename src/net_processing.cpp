 ...
 *  We have 4 times smaller block times in Unifyroom, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Unifyroom Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // UNFY this code also handles non-TXs (Unifyroom specific messages)
