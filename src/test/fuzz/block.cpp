...
FUZZ_TARGET_INIT(block, initialize_block)
{
    ...
    const bool valid_incl_pow_and_merkle = CheckBlockD(block, validation_state_pow_and_merkle, consensus_params, /* fCheckPOW= */ true, /* fCheckMerkleRoot= */ true);
    ...
    const bool valid_incl_pow = CheckBlockD(block, validation_state_pow, consensus_params, /* fCheckPOW= */ true, /* fCheckMerkleRoot= */ false);
    ...
    const bool valid_incl_merkle = CheckBlockD(block, validation_state_merkle, consensus_params, /* fCheckPOW= */ false, /* fCheckMerkleRoot= */ true);
    ...
    const bool valid_incl_none = CheckBlockD(block, validation_state_none, consensus_params, /* fCheckPOW= */ false, /* fCheckMerkleRoot= */ false);
